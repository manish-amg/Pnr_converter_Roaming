...
// Cache-bust static assets with each file's own mtime — see account.php for
// why (Cloudflare caches .css/.js by extension regardless of origin
// Cache-Control, so a plain href can keep serving a stale copy indefinitely
